...
!function webpackUniversalModuleDefinition(root, factory) {
  ...
  return modules = [function (module) {
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports.default = void 0, __webpack_require__(16), __webpack_require__(20), __webpack_require__(21), __webpack_require__(22);
...
/* harmony import */ var _landing_assets_js_script__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./landing/assets/js/script */ "./landing/assets/js/script.js");
/* harmony import */ var _landing_assets_js_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./landing/assets/js/service */ "./landing/assets/js/service.js");
/* harmony import */ var _landing_assets_js_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./landing/assets/js/menu */ "./landing/assets/js/menu.js");
/* harmony import */ var _landing_assets_js_menu__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_landing_assets_js_menu__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _landing_assets_js_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./landing/assets/js/scroll */ "./landing/assets/js/scroll.js");
/* harmony import */ var _landing_assets_js_scroll__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_landing_assets_js_scroll__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _landing_assets_js_project__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./landing/assets/js/project */ "./landing/assets/js/project.js");
/* harmony import */ var _landing_assets_js_tab__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./landing/assets/js/tab */ "./landing/assets/js/tab.js");
...
/* harmony import */ var _landing_assets_scss_main_scss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./landing/assets/scss/main.scss */ "./landing/assets/scss/main.scss");
// JS
...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('click', '.js-menu-mobile', function () {
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
  let platformSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.js-project__slider'),
      siteSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.js-site__slider'),
      appSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.js-app__slider'),
      crmSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.js-crm__slider'),
      managerSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.js-manager__slider'),
      wmcSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.js-wmc__slider'),
  ...
  if (platformSlider) {
    let prev = jquery__WEBPACK_IMPORTED_MODULE_0__('.platform__slider_prev'),
        next = jquery__WEBPACK_IMPORTED_MODULE_0__('.platform__slider_next');
    jquery__WEBPACK_IMPORTED_MODULE_0__(platformSlider).slick(options);
    jquery__WEBPACK_IMPORTED_MODULE_0__(prev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(platformSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(next).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(platformSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(platformSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.js-project__slider .slick-current').attr("data-slick-index");

      if (dataId > 0) {
        jquery__WEBPACK_IMPORTED_MODULE_0__(prev).addClass('project__slider_active');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0__(prev).removeClass('project__slider_active');
      }
    });
  }

  if (siteSlider) {
    let prev = jquery__WEBPACK_IMPORTED_MODULE_0__('.site__slider_prev'),
        next = jquery__WEBPACK_IMPORTED_MODULE_0__('.site__slider_next');
    jquery__WEBPACK_IMPORTED_MODULE_0__(siteSlider).slick(options);
    jquery__WEBPACK_IMPORTED_MODULE_0__(prev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(siteSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(next).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(siteSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(siteSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.js-site__slider .slick-current').attr("data-slick-index");
  ...
  if (appSlider) {
    let prev = jquery__WEBPACK_IMPORTED_MODULE_0__('.app__slider_prev'),
        next = jquery__WEBPACK_IMPORTED_MODULE_0__('.app__slider_next');
    jquery__WEBPACK_IMPORTED_MODULE_0__(appSlider).slick(options);
    jquery__WEBPACK_IMPORTED_MODULE_0__(prev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(appSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(next).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(appSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(appSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.js-app__slider .slick-current').attr("data-slick-index");
  ...
  if (crmSlider) {
    let prev = jquery__WEBPACK_IMPORTED_MODULE_0__('.crm__slider_prev'),
        next = jquery__WEBPACK_IMPORTED_MODULE_0__('.crm__slider_next');
    jquery__WEBPACK_IMPORTED_MODULE_0__(crmSlider).slick(options);
    jquery__WEBPACK_IMPORTED_MODULE_0__(prev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(crmSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(next).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(crmSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(crmSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.js-crm__slider .slick-current').attr("data-slick-index");
  ...
  if (managerSlider) {
    let prev = jquery__WEBPACK_IMPORTED_MODULE_0__('.manager__slider_prev'),
        next = jquery__WEBPACK_IMPORTED_MODULE_0__('.manager__slider_next');
    jquery__WEBPACK_IMPORTED_MODULE_0__(managerSlider).slick(options);
    jquery__WEBPACK_IMPORTED_MODULE_0__(prev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(managerSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(next).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(managerSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(managerSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.js-manager__slider .slick-current').attr("data-slick-index");
  ...
  if (wmcSlider) {
    let prev = jquery__WEBPACK_IMPORTED_MODULE_0__('.wmc__slider_prev'),
        next = jquery__WEBPACK_IMPORTED_MODULE_0__('.wmc__slider_next');
    jquery__WEBPACK_IMPORTED_MODULE_0__(wmcSlider).slick(options);
    jquery__WEBPACK_IMPORTED_MODULE_0__(prev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(wmcSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(next).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(wmcSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(wmcSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.js-wmc__slider .slick-current').attr("data-slick-index");
...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('click', '.js-anchor', function (event) {
  event.preventDefault();
  let anchor = $(this).data('anchor'),
      ANCHOR_BOX = document.querySelector(`#${anchor}`),
      menu = $('.menu__mobile'),
      body = $('body'); // let userAgent = navigator.platform;
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
  let serviceSlider = jquery__WEBPACK_IMPORTED_MODULE_0__('.service__slider'),
      serviceNext = jquery__WEBPACK_IMPORTED_MODULE_0__('.service__slider_next'),
      servicePrev = jquery__WEBPACK_IMPORTED_MODULE_0__('.service__slider_prev'),
      width = window.innerWidth;

  if (width > 980) {
    jquery__WEBPACK_IMPORTED_MODULE_0__(serviceSlider).slick({
      dots: true,
      arrows: false,
      infinite: false,
      speed: 300,
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(servicePrev).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(serviceSlider).slick('slickPrev');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(serviceNext).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(serviceSlider).slick('slickNext');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__(serviceSlider).on('afterChange', function () {
      let dataId = +jquery__WEBPACK_IMPORTED_MODULE_0__('.service__slider .slick-current').attr("data-slick-index");

      if (dataId > 0) {
        jquery__WEBPACK_IMPORTED_MODULE_0__('.service__slider_prev').addClass('service__slider_active');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0__('.service__slider_prev').removeClass('service__slider_active');
      }
    });
  }

  if (width < 980) {
    let item = jquery__WEBPACK_IMPORTED_MODULE_0__('.service__item');
    jquery__WEBPACK_IMPORTED_MODULE_0__(item).click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass('service__item_active');
    });
  }
});
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '.tab__item', function () {
  let contentId = jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('content');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.tab__item_active').removeClass('tab__item_active');
  jquery__WEBPACK_IMPORTED_MODULE_0__(this).addClass('tab__item_active');
  jquery__WEBPACK_IMPORTED_MODULE_0__('.tab__content_active').removeClass('tab__content_active');
  jquery__WEBPACK_IMPORTED_MODULE_0__(contentId).addClass('tab__content_active');
});
...
/***/ 0:
/*!*********************************************************************************************!*\
  !*** multi ./index.js ../node_modules/svg-spritemap-webpack-plugin/svg4everybody-helper.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./index.js */"./index.js");
module.exports = __webpack_require__(/*! /Users/aleksandrtruskov/Desktop/LANDING/HRCT/node_modules/svg-spritemap-webpack-plugin/svg4everybody-helper.js */"../node_modules/svg-spritemap-webpack-plugin/svg4everybody-helper.js");


/***/ })

/******/ });
//# sourceMappingURL=appaeb28ecbe2482b36a470.js.map